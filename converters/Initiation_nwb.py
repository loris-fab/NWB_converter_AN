...
def files_to_config_Rewarded(mat_file, csv_file,output_folder="data"):
    ...
    config = {
        'session_metadata': {
            ...
            'notes': "Combination of high-density extracellular electrophysiological recordings (from wS1, tjM1, mPFC) with high-speed videography of orofacial movements of mice performing a psychometric whisker sensory detection task reported by licking.",
            'pharmacology': 'na',
            'protocol': 'na',
