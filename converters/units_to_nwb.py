...
def add_units_container(nwb_file, data, unique_values, mat_file ,regions):
    ...
    with h5py.File(mat_file, 'r') as f:
        ...
        nwb_file.add_unit_column("Target_area", "Localization target: mPFC (the medial prefrontal cortex : a higher-order area potentially involved in decision-making) or WS1 (C2 barrel column of whisker primary somatosensory cortex : the first cortical area involved in the processing of the whisker stimulus) or tjm1 (tongue/jaw primary motor cortex : a motor area involved in the control of directional licking.)")
